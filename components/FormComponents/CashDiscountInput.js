...
import {updateCashDiscountState, updateNewFees, updateCommon } from '../../redux/actions';
...
class CashDiscountInput extends Component {
    ...
    renderNewFees(below, part) {
        ...
        console.log('State.additional', State.additional);
        if(below.startsWith("Fees") && State.additional != {}) {
