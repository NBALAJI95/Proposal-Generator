...
import FormRow from "../components/FormComponents/FormRow.js";
import ProposalHeading from '../components/FormComponents/proposalHeading';
                ...
                <div style={box}>
                    ...
                    <div className="row" style={{margin: "0", fontSize:"0.95rem"}}>
                        ...
                        <div className="col-5" style={Object.assign({}, headingStyle, {borderBottom: "1.5px solid black"})}>
                            <div>
                                <span style={headingStyle}> {""} </span>
                                <span style={{fontWeight: "bold", float: "right"}}> {currency(partB.Total.Total_Fee/partA.volume*100)+" %"} </span>
                            </div>
                        </div>
                    </div>
