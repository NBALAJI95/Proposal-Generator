...
import BusinessInfo from '../components/FormComponents/BusinessInfo.js';
import ProcessingFee from '../components/FormComponents/ProcessingFee.js';
import AdditionalFee from '../components/FormComponents/AdditionalFee.js';
import AssociationNAuth from '../components/FormComponents/AssociationNAuth.js';
import Total from '../components/FormComponents/Total.js';
import Excel from '../components/FormComponents/Excel.js';
import { resetForm, fetchForm, updateCommon, resetCashDiscount, copyCashDiscount } from "../redux/actions";
import Link from 'next/link';
import CashDiscountInput from '../components/FormComponents/CashDiscountInput';
import BusinessInfoCashDiscount from '../components/FormComponents/BusinessInfoCashDiscount';
            ...
            <Form className="Form-Container">
              ...
              <div style={{float: "right"}} className="form-group">
                ...
                {console.log('Passing props', this.props.CashDiscountState)}
				        <Link prefetch href={{ pathname: '/CashDiscount'}}>
          ...
          <div className="container-fluid">
            <Form onSubmit={this.handleSubmit.bind(this)} className="Form-Container">
              ...
              <div style={{float: "right"}} className="form-group">
                ...
                <Link prefetch href={`/Dashboard`}><Button color="success"> Dashboard for PDF </Button></Link>
              </div>
              <br/>
              <br/>
            </Form>
